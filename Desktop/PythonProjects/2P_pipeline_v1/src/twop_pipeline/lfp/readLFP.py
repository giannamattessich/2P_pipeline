...
def extract_lfp(
    ...
    def _process_block(block_samps_nc):
        ...
        assert filtered_cs.shape[1] == sel_cs.shape[1], "Filter is changing length (chunk-edge truncation)."
...
# def lfp_times(intan_data, lfp_fs= 1250, export= False):
#     intan_time = np.arange(len(intan_data)) / lfp_fs
#     if export:
